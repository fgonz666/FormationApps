...
\begin{figure}
	\centering
	\includegraphics[width=0.333\linewidth]{./Captures/nextcloud-client.fenetre.principale.png}
	\caption{Le client pour PC (MacOS, Windows, ici : Linux}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[width=0.333\linewidth]{./Captures/nextcloud-client.smartphone.jpg}
